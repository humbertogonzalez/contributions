...
class AddAgregableAlCarritoProductAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply(): void
    {
        ...
        $eavSetup->addAttribute(
            ...
            'no_agregable_al_carrito',
            [
                'type' => 'int',
                'label' => 'No Agregable al carrito',
                'input' => 'boolean',
