...
/**
 * Catalog product decimal backend attribute model
 *
 */
namespace Redegal\Catalog\Model\Product\Attribute\Backend;

class DecimalNumber extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
